...
node {
 stage("Toggle Shutter"){
   echo "This job will soon be DEPRECATED once all the frontend applications will be migrated to Azure Kubernetes Service."
   echo "All efforts are going towards using the new solution outlined below:"
   echo "http://localhost:4567/ways-of-working/new-component/shutter.html#shutter-implementation-and-design"
