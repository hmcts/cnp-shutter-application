...
properties([
  parameters([
    string(name: 'DEPRECATION', value: 'WARNING', description: 'The JOB will soon be _DEPRECATED_ once all the frontend applications will be migrated to Azure Kubernetes Service.'),
